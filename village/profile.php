...
<body id="page-top">
 ...
 <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav" style="background-color:red;">
    <div class="container">
      ...
      <p style="margin-top: 30px; color: white; font-style: italic; text-shadow: 2px 2px 2px black">AC3AS</p>
        ...
        <div class="col-sm-12 text-center">
            ...
            <p class="text-muted">User Address : <?php echo $row['u_add']; ?></p>
               <p class="text-muted">User Addhar No. : <?php echo $row['u_adar']; ?></p>
                            <button type="button" class="btn btn-primary btn-lg"><a href="update.php?u_id=<?php echo $u_id; ?>" style="color: white;">Update Now</a></button><br><br>
...
<br><br>
        ...
        <div class="mx-auto text-center " >
          <p class="large text-muted">Analysis Of Colonizatuon And Assert With Agile Accesser System.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class=" ">
        ...
        <div class="col-md-4">
          ...
          <span class="copyright">Copyright &copy;2020 develope by AC3AS project group</span>
        </div>
        </div>
